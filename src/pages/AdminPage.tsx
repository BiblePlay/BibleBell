        ...
        <section className="admin-portable-guide">
          ...
          <details className="admin-help-details">
            ...
            <div className="admin-help-content">
              ...
              <section>
                <h3>4. 문제 수정하기</h3>
                <p>카테고리와 번호는 문제의 자리입니다. 문제·정답·힌트·설명 등을 수정한 뒤 저장하면 같은 컴퓨터의 같은 브라우저에 유지됩니다. 연결된 BibleBell_Data 폴더의 쓰기 권한이 유지되는 동안에는 최신 문제 내용이 questions.json에도 자동 동기화됩니다.</p>
              </section>
              <section>
                <h3>5. 문제유형 변경하기</h3>
                <p>카테고리가 문제유형을 강제로 고정하지 않습니다. 예를 들어 숨은그림 카테고리의 한 자리를 일반 문제나 객관식 문제로 바꿀 수 있습니다. 일반, OX, 그림, 인물, 영상, 숨은그림 문제와 단답형·객관식 답변 방식을 문제별로 바꿀 수 있습니다.</p>
              </section>
              <section>
                <h3>6. 사지선다 보기 작성</h3>
                <p>답변유형을 <b>객관식</b>으로 선택하고 보기 1~4를 입력하세요. 현재 샘플의 객관식 개수는 고정값이 아닙니다. 다른 문제를 객관식으로 바꾸거나 기존 객관식을 단답형으로 바꿔도 Excel 내보내기와 다시 불러오기에서 그 상태가 유지됩니다.</p>
              </section>
              <section>
              ...
              <section>
                <h3>8. Excel 내보내기</h3>
                <p><b>엑셀 다운로드</b>는 현재 100문제를 표로 내보냅니다. 번호, 카테고리, 문제유형, 답변유형, 문제, 정답, 보기1~4, 점수, 힌트, 설명, 문제이미지, 정답이미지, 미디어 경로가 포함됩니다. Excel은 문제 내용을 관리하기 좋은 파일이며 실제 미디어 파일 자체를 담지는 않습니다.</p>
              </section>
              <section>
                <h3>9. Excel 불러오기</h3>
                <p>Excel은 정확히 100개 문제 위치를 가지고 있어야 합니다. 행 순서를 정렬하거나 필터를 사용해도 <b>카테고리 + 번호</b>를 기준으로 원래 문제판 위치에 복원됩니다. Excel만 가져온 경우 미디어 경로는 들어오지만 실제 파일은 BibleBell_Data/media 또는 이미 저장된 브라우저 미디어가 있어야 화면에 표시됩니다.</p>
              </section>
              <section>
                <h3>10. BibleBell_Data란 무엇인가요?</h3>
                <p>BibleBell_Data는 다른 컴퓨터로 이동하고 백업하기 위한 개인 데이터 묶음입니다. 기본적으로 <b>questions.xlsx, questions.json, manifest.json, media/images, media/videos, media/audio</b>와 사용안내 파일이 들어갑니다. GitHub에는 사용자의 개인 미디어가 올라가지 않습니다.</p>
              </section>
              <section>
